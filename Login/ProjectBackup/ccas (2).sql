...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2019 at 07:50 AM
...
(17103027, 'IEEE', 4, 4, 4, 4, 4, 4, 2, 2, 1, 7, 2, 0);
...
(17103033, 'Undergraduate', 'CSE', 'Third', 'Puneet Kapoor', 'puneetkapoor1212@gmail.com', 9876543210, 9, 'No', 'No', 'Tarun Kapoor', 'Sector 5 Panchkula', 0, 0, 0);
...
--
ALTER TABLE `event_details`
  MODIFY `Event_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120190003;
