...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 10:24 AM
...
(120190020, 'Event', 17103032, 'First', 6),
(120190021, 'Event', 17103027, 'Participation', 1),
(120190021, 'Event', 17103032, 'Participation', 1),
(120190021, 'Event', 17103033, 'Fourth', 2),
(120190022, 'Event', 17103027, 'organizers', 0),
(120190022, 'Event', 17103027, 'Participation', 1),
(120190022, 'Event', 17103032, 'Participation', 1),
(120190022, 'Event', 17103033, 'Fourth', 2),
...
('Third', 17103032, 'Surjeet Kumar', 'ACM_CSS', 10, 6, 0, 16);
...
(120190020, 'ACM_CSS', 'CSS Quiz', 'IIT Bombay', '2019-11-16', '', '', 0, 0, 0, 0),
(120190021, 'ACM_CSS', 'Treasure Hunt MLH', 'L21 CSRC', '2019-10-10', 'MLH', 'Technical', 100, 1, 1, 0),
(120190022, 'ACM_CSS', 'CSS QUIZ MLH', 'L22 CSRC', '2019-11-17', 'MLH', 'Technical', 150, 1, 1, 0);
...
--
-- Dumping data for table `ic_award`
--

INSERT INTO `ic_award` (`Year`, `SID`, `Name`, `Society_Associated`, `P_Marks`, `A_Marks`, `O_Marks`, `Total_Marks`) VALUES
...
('17103032', 'e10adc3949ba59abbe56e057f20f883e', 'Student', 'NotApplicable'),
...
(17103027, 'ACM_CSS', 0, 0, 0, 0, 0, 0, 2, 8, 0, 0, 0, 0),
(17103027, 'IEEE', 4, 4, 4, 4, 4, 4, 2, 7, 1, 7, 2, 0),
(17103032, 'ACM_CSS', 0, 0, 0, 12, 0, 0, 2, 6, 0, 0, 0, 0),
(17103033, 'ACM_CSS', 4, 4, 4, 2, 6, 2, 6, 0, 4, 7, 6, 2);
...
(17103032, 'CSS Quiz', 'IIT Bombay', '2019-11-16', 'First', 'National_P', 'ACM_CSS', 'Requests/Certificate-17103032-1573966751864', 'Accept', 320190004);
...
(17103032, 'Undergraduate', 'CSE', 'Third', 'Surjeet Kumar', 'lohansurjeet@gmail.com', 9872222173, 9.88, 'No', 'No', 'Jagbir Singh', 'Hno 3681 Jind Haryana', 0, 0, 0),
(17103033, 'Undergraduate', 'CSE', 'Fourth', 'Puneet Kapoor', 'puneetkapoor1212@gmail.com', 9876543210, 9, 'No', 'No', 'Tarun Kapoor', 'Sector 5 Panchkula', 1, 1, 0);
...
--
ALTER TABLE `event_details`
  MODIFY `Event_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120190023;

--
-- AUTO_INCREMENT for table `pending_requests`
--
ALTER TABLE `pending_requests`
  MODIFY `Request_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=320190005;
